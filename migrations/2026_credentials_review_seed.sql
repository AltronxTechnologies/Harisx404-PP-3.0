...
VALUES
  ('CS50''s Introduction to Programming with Python', 'Harvard University', '2026-08-01', 'https://cs50.harvard.edu/certificates/09de786b-0b5e-445b-a3bb-e672b623b3ea', 10, 'published', 'https://www.harvard.edu/favicon.ico', NULL, NULL, NULL, TRUE, 'Completed Harvard CS50P, covering Python fundamentals, functions, object-oriented programming, file handling, regular expressions, APIs, exceptions, and automated testing with pytest.', ARRAY['Python', 'Software Development', 'OOP', 'File Handling', 'Regular Expressions', 'APIs', 'Exception Handling', 'Pytest', 'CLI Development', 'Cybersecurity'], 'Web Development', FALSE),
