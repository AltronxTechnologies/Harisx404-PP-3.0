...
VALUES
  ...
  ('Introduction to Cybersecurity', 'Cisco', '2026-06-01', 'https://www.credly.com/badges/660327f0-5dc5-48d1-95e7-e4375d1d3f14/linked_in_profile', 20, 'published', NULL, NULL, '660327f0-5dc5-48d1-95e7-e4375d1d3f14', NULL, TRUE, 'Official Cisco credential validating foundational knowledge of cyber threats, network vulnerabilities, security best practices, and data confidentiality.', ARRAY['Cybersecurity', 'Threat Detection', 'Network Security', 'Vulnerability Analysis', 'Data Privacy'], 'Cybersecurity', FALSE),
