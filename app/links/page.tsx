...
export const metadata: Metadata = {
  title: "Links | Muhammad Haris",
  description:
    "All of Muhammad Haris's important links in one place — social profiles, latest writing, and ways to get in touch.",
};
        ...
        <GridWrapper>
          <div className="text-center">
            ...
            <h1 className="mx-auto mt-3 max-w-2xl font-display text-4xl leading-[1.05] text-text-primary md:text-5xl">
              Hey, I&apos;m{" "}
              <em className="text-gradient-accent italic">Haris!</em>
            </h1>
          </div>
        </GridWrapper>
        <GridWrapper>
          <div className="mx-auto max-w-xl text-center md:mt-8">
            <p className="leading-8 text-text-secondary">
              I&apos;m a Full-Stack MERN Developer, Cybersecurity &amp; AI
              Professional, and BSIT Graduate.
            </p>
          </div>
        </GridWrapper>
        <GridWrapper>
