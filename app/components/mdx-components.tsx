...
// Individual exports so Server Components can build a components map with
// client references as values (the `sharedComponents` object export becomes
// an opaque client-reference proxy in an RSC and cannot be spread there).
...
export {
  ...
  ProsCard as MdxProsCard,
  ConsCard as MdxConsCard,
  IdeaQuote as MdxIdeaQuote,
  InfoQuote as MdxInfoQuote,
  ThoughtQuote as MdxThoughtQuote,
  WarningQuote as MdxWarningQuote,
  Code as MdxCode,
