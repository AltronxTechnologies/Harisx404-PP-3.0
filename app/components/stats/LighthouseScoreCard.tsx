...
export function LighthouseScoreCard({
  ...
  const cardClassName = "group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border-primary bg-bg-primary p-5 transition-all duration-300 hover:border-indigo-400 hover:bg-white dark:bg-[#1A1F2B] dark:hover:bg-[#1A1F2B]";
