        ...
        <div className="relative z-20 flex h-full flex-col">
          ...
          <div className="grid flex-1 grid-cols-2 gap-3">
            {(Object.keys(REACTION_CONFIG) as ReactionType[]).map((type) => {
              ...
              return (
                <div key={type} className={`flex flex-col items-center justify-center rounded-xl border border-border-primary/50 p-3 bg-white/50 dark:bg-[#1A1F2B]/50`}>
                  <div className="mb-2">
