...
const levelColors = {
  NONE: "bg-gray-200 dark:bg-[#1A1F2B]",
...
export function ContributionGraphCard({
  ...
  const cardClassName = "group relative flex h-full min-h-[220px] flex-col overflow-hidden rounded-2xl border border-border-primary bg-bg-primary p-6 transition-all duration-300 hover:border-indigo-400 hover:bg-white dark:bg-[#1A1F2B] dark:hover:bg-[#1A1F2B]";
