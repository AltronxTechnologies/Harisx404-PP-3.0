        ...
        <div className={cardClassName}>
          ...
          <div className="relative h-[280px] flex-shrink-0">
            ...
            <div
              ...
              className="absolute inset-4 flex flex-col overflow-hidden rounded-lg border border-border-primary bg-white dark:bg-[#1A1F2B] shadow-sm"
            >
              {/* Mini article header bar */}
              <div className="flex flex-shrink-0 items-center gap-1.5 border-b border-border-primary/50 bg-slate-50 dark:bg-white/[0.04] px-3 py-2">
