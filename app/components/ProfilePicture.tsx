...
export function ProfilePicture() {
  // TODO Phase 5: Replace these with Cloudinary URLs of your real photos
  ...
  const changeImage = () => {
    setIsChanging(true);
    // TODO Phase 5: Add your own Cloudinary photo URLs here to enable the rotation feature
    const images = [
      "https://res.cloudinary.com/i22q5puf/image/upload/v1786526260/portfolio/haris_primary_photo.png",
    ];
    const availableImages = images.filter((img) => img !== imageSrc);
    const randomIndex = Math.floor(Math.random() * availableImages.length);
    setImageSrc(availableImages[randomIndex] ?? images[0]);
  };
