...
export function SectionHeading({
  ...
  return (
    <div className={`${centered ? "text-center" : "text-left"} ${className}`}>
      ...
      <h2
        id={headingId}
        className={`heading-glow mt-4 max-w-xl text-balance [font-family:var(--font-instrument-serif),serif] text-[46px] font-medium leading-none tracking-tight text-text-primary md:text-[56px] md:tracking-[-1.5px] ${
          centered ? "mx-auto" : ""
        }`}
      >
        {children}
