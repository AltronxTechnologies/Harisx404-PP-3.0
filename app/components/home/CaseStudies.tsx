      ...
      >
        {coverHeading !== "title" && (
          <Link
            ...
            className="font-display text-[26px] font-semibold text-text-primary transition-colors [font-family:'Reference_Bluu_Next_Bold',Georgia,serif] hover:text-text-secondary"
          >
            {project.title}
          </Link>
        )}
        {coverHeading === "title" ? (
          <>
            {bodyHiddenOnXl && (
              ...
              <Link
                href={`/projects/${project.slug}`}
                className="mb-2 block font-display text-[26px] font-semibold leading-tight text-text-primary transition-colors [font-family:'Reference_Bluu_Next_Bold',Georgia,serif] hover:text-text-secondary"
              >
                {project.title}
              </Link>
            )}
  ...
  return (
    <div key={project.slug}>
      <div className="flex items-center gap-3">
        ...
        />
        <h3 className="font-display text-[32px] font-semibold leading-tight text-text-primary [font-family:'Reference_Bluu_Next_Bold',Georgia,serif]">
          {project.title}
        </h3>
      </div>
