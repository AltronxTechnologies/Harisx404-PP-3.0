      ...
      >
        {coverHeading !== "title" && (
          <Link
            ...
            className="font-display text-2xl font-bold text-text-primary transition-colors [-webkit-text-stroke:0.5px_currentColor] [font-family:'Reference_Bluu_Next_Bold',Georgia,serif] hover:text-text-secondary"
          >
            {project.title}
          </Link>
        )}
        {coverHeading === "title" ? (
          <>
            {bodyHiddenOnXl && (
              ...
              <Link
                href={`/projects/${project.slug}`}
                className="mb-2 block font-display text-2xl font-bold leading-tight text-text-primary transition-colors [-webkit-text-stroke:0.5px_currentColor] [font-family:'Reference_Bluu_Next_Bold',Georgia,serif] hover:text-text-secondary"
              >
                {project.title}
              </Link>
            )}
  ...
  return (
    <div key={project.slug}>
      <div className="flex items-center gap-3">
        ...
        />
        <h3 className="font-display text-3xl font-bold leading-tight text-text-primary [-webkit-text-stroke:0.5px_currentColor] [font-family:'Reference_Bluu_Next_Bold',Georgia,serif]">
          {project.title}
        </h3>
      </div>
