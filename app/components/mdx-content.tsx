...
const useMDXComponent = (code: string) => {
  try {
    ...
    // Fallback for uncompiled string mock data
    const FallbackComponent = () => <div dangerouslySetInnerHTML={{ __html: code }} />;
    FallbackComponent.displayName = 'FallbackMDXComponent';
