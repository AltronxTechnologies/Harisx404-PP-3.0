...
const variants = {
  ...
  outline: clsx(
    ...
    "rounded-full border border-transparent shadow ring-1 ring-black/10 dark:ring-white/15",
    "whitespace-nowrap text-sm font-medium text-gray-950 dark:text-text-primary",
    "data-[disabled]:bg-transparent data-[hover]:bg-gray-50 dark:data-[hover]:bg-white/[0.06] data-[disabled]:opacity-40",
  ),
};
