...
export function ConnectionsBento({
  ...
  return (
    <BentoCard height="h-[300px]" linkTo={linkTo}>
      ...
      >
        <div className="absolute inset-y-0 left-0 z-20 w-1/3 bg-gradient-to-r from-bg-primary to-transparent group-hover:from-white dark:group-hover:from-bg-primary"></div>
        <div className="absolute inset-y-0 right-0 z-20 w-1/3 bg-gradient-to-l from-bg-primary to-transparent group-hover:from-white dark:group-hover:from-bg-primary"></div>
        <div>
          <BackgroundPattern />
