      ...
      <div className="mt-3 flex min-h-4 items-center">
        {credential.credential_id && (
          <div className="flex min-w-0 items-center gap-2">
            ...
            <button type="button" onClick={copyId} aria-label={copied ? "Credential ID copied" : `Copy credential ID for ${credential.title}`} className="inline-flex size-5 shrink-0 items-center justify-center rounded text-text-secondary outline-none transition-colors hover:text-text-primary focus-visible:outline focus-visible:outline-1 focus-visible:outline-offset-1 focus-visible:outline-text-primary">
