...
const icons = {
  ...
  quote: <Quote className="size-5" aria-hidden="true" />,
        ...
        <div className="relative px-4 xl:px-0">
          ...
          <header className="relative mx-auto max-w-3xl text-center">
            ...
            <h1 className="heading-glow mx-auto mt-4 max-w-xl text-balance [font-family:var(--font-instrument-serif),serif] text-[46px] font-medium leading-none tracking-tight text-text-primary md:text-[56px] md:tracking-[-1.5px]">
              Privacy{" "}
              <span className="animate-gradient-x text-colorfull px-1 pb-1 italic [text-shadow:none] motion-reduce:animate-none">Policy.</span>
            </h1>
          ...
          <div className="space-y-8 p-4 lg:col-span-8 lg:p-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <FeatureCard icon={icons.note} tag="Community Wall Notes">
                If you sign in through an offered provider to post, an account
                identifier, note, display name, and available avatar are stored.
                Your note and profile details may appear publicly.
              </FeatureCard>
              ...
              <FeatureCard icon={icons.quote} tag="Testimonials">
                If you submit a testimonial, your name, role, email, headline,
                and quote are stored for review. Approved text and profile
                details may appear publicly.
              </FeatureCard>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="space-y-8 p-4 lg:col-span-8 lg:p-6">
            ...
            <div className="grid gap-4">
              <ToolCard icon={icons.database} title="Data and sign-in">
                A database and authentication provider stores site content and
              ...
              <ToolCard icon={icons.message} title="Search and AI assistant">
                ...
                your messages and relevant chat history are sent to an external
                AI provider to generate a reply. Avoid sharing sensitive details.
              </ToolCard>
              <ToolCard icon={icons.image} title="Media and avatars">
                Images may load from external hosting or avatar services. If
                you submit a testimonial, an email-derived hash may be used
                to check for an available profile image.
              </ToolCard>
