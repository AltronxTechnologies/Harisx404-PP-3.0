...
export const metadata: Metadata = {
  title: "Community Wall | Muhammad Haris",
  description:
...
export default async function Page({ searchParams }: SearchParamProps) {
  ...
  return (
    <>
      ...
      {/* Page Header */}
      <div className="relative mt-14 pb-8 md:mt-16">
        <HeroTexture />
        <GridWrapper>
          <div className="space-y-6">
            <div className="space-y-3 text-center">
              ...
              <h1 className="mx-auto max-w-2xl font-display text-4xl leading-[1.05] text-text-primary md:text-5xl">
                Notes from{" "}
                <em className="text-gradient-accent italic">visitors</em>
              </h1>
      ...
      <div className="block min-h-screen md:hidden">
        ...
        <div className="pointer-events-none sticky bottom-0 -mt-40 mb-8 flex h-32 items-end justify-center bg-gradient-to-b from-transparent to-zinc-300 dark:to-bg-primary pb-8">
          <Link href="/community-wall?show=true">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className="text-text-tertiary group-hover:text-gray-200"
              >
                <path
                  d="M12 4V20M4 12H20"
                  stroke="currentColor"
